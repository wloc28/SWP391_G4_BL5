...
-- =============================================
-- 3. PROVIDERS (Đã thêm price, product_name, product_code, purchase_price, quantity)
-- =============================================
...
CREATE TABLE `providers` (
  ...
  `product_code` varchar(50) DEFAULT NULL COMMENT 'Mã sản phẩm fix cứng (VD: VT10K, VN20K, MB50K)',
  `product_name` varchar(100) DEFAULT NULL COMMENT 'Tên sản phẩm (VD: Thẻ 10.000đ, Thẻ 20.000đ)',
  ...
  `quantity` int DEFAULT 0 COMMENT 'Số lượng hàng còn ở provider',
  `image_url` varchar(255) DEFAULT NULL,
  `status` enum('ACTIVE','INACTIVE') DEFAULT 'ACTIVE',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
-- Providers với 20 sản phẩm thẻ nạp điện thoại (created by admin)
-- VIETTEL - 7 sản phẩm
INSERT INTO `providers` (`provider_id`,`provider_name`,`provider_type`,`product_code`,`product_name`,`price`,`purchase_price`,`quantity`,`image_url`,`status`,`created_at`,`updated_at`,`is_deleted`,`created_by`,`deleted_by`) VALUES 
(1,'Viettel','TEL','VT10K','Thẻ 10.000đ',10000.00,9500.00,100,NULL,'ACTIVE',NOW(),NOW(),b'0',1,NULL),
(2,'Viettel','TEL','VT20K','Thẻ 20.000đ',20000.00,19000.00,150,NULL,'ACTIVE',NOW(),NOW(),b'0',1,NULL),
(3,'Viettel','TEL','VT30K','Thẻ 30.000đ',30000.00,28500.00,120,NULL,'ACTIVE',NOW(),NOW(),b'0',1,NULL),
(4,'Viettel','TEL','VT50K','Thẻ 50.000đ',50000.00,47500.00,200,NULL,'ACTIVE',NOW(),NOW(),b'0',1,NULL),
(5,'Viettel','TEL','VT100K','Thẻ 100.000đ',100000.00,95000.00,180,NULL,'ACTIVE',NOW(),NOW(),b'0',1,NULL),
(6,'Viettel','TEL','VT200K','Thẻ 200.000đ',200000.00,190000.00,120,NULL,'ACTIVE',NOW(),NOW(),b'0',1,NULL),
(7,'Viettel','TEL','VT500K','Thẻ 500.000đ',500000.00,475000.00,80,NULL,'ACTIVE',NOW(),NOW(),b'0',1,NULL);

-- VINAPHONE - 7 sản phẩm
INSERT INTO `providers` (`provider_id`,`provider_name`,`provider_type`,`product_code`,`product_name`,`price`,`purchase_price`,`quantity`,`image_url`,`status`,`created_at`,`updated_at`,`is_deleted`,`created_by`,`deleted_by`) VALUES 
(8,'Vinaphone','TEL','VN10K','Thẻ 10.000đ',10000.00,9600.00,100,NULL,'ACTIVE',NOW(),NOW(),b'0',1,NULL),
(9,'Vinaphone','TEL','VN20K','Thẻ 20.000đ',20000.00,19100.00,150,NULL,'ACTIVE',NOW(),NOW(),b'0',1,NULL),
(10,'Vinaphone','TEL','VN30K','Thẻ 30.000đ',30000.00,28600.00,120,NULL,'ACTIVE',NOW(),NOW(),b'0',1,NULL),
(11,'Vinaphone','TEL','VN50K','Thẻ 50.000đ',50000.00,47600.00,200,NULL,'ACTIVE',NOW(),NOW(),b'0',1,NULL),
(12,'Vinaphone','TEL','VN100K','Thẻ 100.000đ',100000.00,95100.00,180,NULL,'ACTIVE',NOW(),NOW(),b'0',1,NULL),
(13,'Vinaphone','TEL','VN300K','Thẻ 300.000đ',300000.00,285000.00,100,NULL,'ACTIVE',NOW(),NOW(),b'0',1,NULL),
(14,'Vinaphone','TEL','VN500K','Thẻ 500.000đ',500000.00,476000.00,80,NULL,'ACTIVE',NOW(),NOW(),b'0',1,NULL);

-- MOBIFONE - 6 sản phẩm
INSERT INTO `providers` (`provider_id`,`provider_name`,`provider_type`,`product_code`,`product_name`,`price`,`purchase_price`,`quantity`,`image_url`,`status`,`created_at`,`updated_at`,`is_deleted`,`created_by`,`deleted_by`) VALUES 
(15,'Mobifone','TEL','MB10K','Thẻ 10.000đ',10000.00,9550.00,100,NULL,'ACTIVE',NOW(),NOW(),b'0',1,NULL),
(16,'Mobifone','TEL','MB20K','Thẻ 20.000đ',20000.00,19050.00,150,NULL,'ACTIVE',NOW(),NOW(),b'0',1,NULL),
(17,'Mobifone','TEL','MB50K','Thẻ 50.000đ',50000.00,47550.00,200,NULL,'ACTIVE',NOW(),NOW(),b'0',1,NULL),
(18,'Mobifone','TEL','MB100K','Thẻ 100.000đ',100000.00,95050.00,180,NULL,'ACTIVE',NOW(),NOW(),b'0',1,NULL),
(19,'Mobifone','TEL','MB200K','Thẻ 200.000đ',200000.00,190500.00,120,NULL,'ACTIVE',NOW(),NOW(),b'0',1,NULL),
(20,'Mobifone','TEL','MB500K','Thẻ 500.000đ',500000.00,475500.00,80,NULL,'ACTIVE',NOW(),NOW(),b'0',1,NULL);

-- Products (created by admin) - Giữ nguyên dữ liệu mẫu ban đầu
...
(2,4,'Viettel 50k',50000.00,NULL,NULL,'ACTIVE',NOW(),NOW(),b'0',1,NULL),
(3,17,'Mobifone 50k',50000.00,NULL,NULL,'ACTIVE',NOW(),NOW(),b'0',1,NULL);
...
(4,3,'SER_MB50_01','CODE_4444',NULL,'AVAILABLE',NOW(),NOW(),b'0',1,NULL);
