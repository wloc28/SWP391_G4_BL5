...
<<<<<<< Updated upstream:MoblieCardStore/web/public/message.jsp
=======
<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<%@taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
>>>>>>> Stashed changes:MobileCardStore/web/view/ViewProfile.jsp
<!DOCTYPE html>
<html>
    <head>
                        ...
                        <div class="card shadow-sm">
                            <div class="card-body">
                                <div class="d-flex flex-wrap gap-3 justify-content-center">
                                    ...
                                    <a href="${pageContext.request.contextPath}/view/testlogin.jsp" class="btn btn-secondary btn-lg">
